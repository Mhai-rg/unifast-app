...
public class MainSystemTest {
    ...
    public void main() {
         ...
         * Replace 'SanAndres_Transaction' with your target system/class name below.
         */
         Main mainSystem = new Main();

        // Start your system and pass our automated scanner into it.
        // If your target method uses a different name (e.g. run, displayMenu), update .start() accordingly.
